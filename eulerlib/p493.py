...
import eulerlib.eulerlib, fractions, math
...
def compute():
	...
	def explore(remain, limit, history):
		if remain == 0:
			...
			for x in hist:
				count *= eulerlib.eulerlib.binomial(BALLS_PER_COLOR, x)
	...
	denominator = eulerlib.eulerlib.binomial(NUM_COLORS * BALLS_PER_COLOR, NUM_PICKED)
